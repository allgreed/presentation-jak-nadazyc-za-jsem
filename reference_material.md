...
- [Jscript wiki](https://en.wikipedia.org/wiki/JScript)
- [W3C historia JSa](https://www.w3.org/community/webed/wiki/A_Short_History_of_JavaScript)
- [Moar, biedaźródło](https://computer-programming-languages.knoji.com/mocha-livescript-javascript-2/)
- [ECMA wiki](https://en.wikipedia.org/wiki/Ecma_International)
- [Standard C++ wiki](https://en.wikipedia.org/wiki/C%2B%2B/CLI)
